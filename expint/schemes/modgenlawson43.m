function [u, v, a, b, c] = modgenlawson43(z, problem)
% MODGENLAWSON43 - Modified generalized Lawson scheme of stiff order 4.
%
% SYNOPSIS:
%   [u, v, a, b, c] = modgenlawson43(z, problem);
%
% PARAMETERS:
...
v = { ez, -phi_2 + phi_3 + 3*phi_4 + 5/24*ez2, 1/6*phi_2-phi_4 - 1/24*ez2; ...
      [],                                  [],                  []; ...
      [],                                 one,                  [] };

b = {phi_1 + 1/2*phi_2 - 2*phi_3 - 3*phi_4 - 5/8*ez2, 1/3*ez2, ...
     1/3*ez2, 1/3*phi_2 + phi_3 + phi_4 - 5/24*ez2; ...
         one, [], [], []; ...
          [], [], [], [] };
