function [u, v, a, b, c] = pec625(z, problem)
% PEC625 - Order 6 exponential general linear method 
%          with s=2 stages and r=5 outputs.
% 
% SYNOPSIS:
%   [u, v, a, b, c] = pec625(z, problem);
%
% PARAMETERS:
...
%
% RETURNS:
%   u   - The u_ij(z) coefficient functions as a 2-by-5 cell array.
%   a   - The a_ij(z) coefficient functions as a 2-by-2 cell array.
%   v   - The v_ij(z) coefficient function  as a 5-by-5 cell array.
%   b   - The b_ij(z) coefficient functions as a 5-by-2 cell array.
