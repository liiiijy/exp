function [u, v, a, b, c] = pec726(z, problem)
% PEC726 - Order 6 exponential general linear method 
%          with s=2 stages and r=5 outputs.
% 
% SYNOPSIS:
%   [u, v, a, b, c] = pec726(z, problem);
%
% PARAMETERS:
...
%
% RETURNS:
%   u   - The u_ij(z) coefficient functions as a 2-by-6 cell array.
%   a   - The a_ij(z) coefficient functions as a 2-by-2 cell array.
%   v   - The v_ij(z) coefficient function  as a 6-by-6 cell array.
%   b   - The b_ij(z) coefficient functions as a 6-by-2 cell array.
...
u = { one, [], [], [], [], []; ...
      ez, -5*phi_2 - 77/6*phi_3 - 71/4*phi_4 - 14*phi_5 - 5*phi_6, ...
