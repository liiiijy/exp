function [u, v, a, b, c] = strehmelweiner(z, problem)
% STREHMELWEINER - ETD scheme of Strehmel and Weiners with stiff order 3.
%
% SYNOPSIS:
%   [u, v, a, b, c] = strehmelweiner(z, problem);
%
% PARAMETERS:
